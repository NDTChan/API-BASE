...
{
    public interface INV_BM_07TT_TCXDService : IBaseService<PHF_BM_07TT_TCXD>
    {
    ...
    public class NV_BM_07TT_TCXDService : BaseService<PHF_BM_07TT_TCXD>, INV_BM_07TT_TCXDService
    {
        private readonly IRepositoryAsync<PHF_BM_07TT_TCXD> _repository;
        public NV_BM_07TT_TCXDService(IRepositoryAsync<PHF_BM_07TT_TCXD> repository) : base(repository)
        {
        ...
        public string UploadFileReport(HttpRequest request, string currentUser, string unitCode, string report, string period, string doiTuong)
        {
            try
            {
                List<PHF_BM_07TT_TCXD> listInsert = new List<PHF_BM_07TT_TCXD>();
                ...
                using (var excelPackage = new ExcelPackage(HttpContext.Current.Request.Files[0].InputStream))
                {
                    ...
                    if (workSheet != null)
                    {
                        ...
                        if (workSheet.Cells[rowHeader, 1] != null)
                        {
                            ...
                            {
                                bmfile_ncdp.TEN_BIEUMAU = "Biểu số 07/TTTC-XD";
                            }
                        }
                        ...
                        if (workSheet.Cells[rowTitle, 1] != null)
                        {
                            ...
                            {
                                bmfile_ncdp.TIEUDE_BIEUMAU = "TỔNG HỢP TÌNH HÌNH THỰC HIỆN THEO HỢP ĐỒNG CÁC GÓI THẦU, HẠNG MỤC CÔNG TRÌNH";
                            }
                        }
                        ...
                        while (workSheet.Cells[startRow, 1].Value != null && !string.IsNullOrEmpty(workSheet.Cells[startRow, 1].Value.ToString()))
                        {
                            ...
                            {
                                PHF_BM_07TT_TCXD detail = new PHF_BM_07TT_TCXD()
                                {
                                    ObjectState = ObjectState.Added,
                                ...
                                detail.TEN_GOITHAU = workSheet.Cells[startRow, 2] != null ? workSheet.Cells[startRow, 2].Value?.ToString() : null;
                                detail.DT_DUYET = workSheet.Cells[startRow, 3] != null ? workSheet.Cells[startRow, 3].Value?.ToString() : null;
                                detail.DT_TINHLAI = workSheet.Cells[startRow, 4] != null ? workSheet.Cells[startRow, 4].Value?.ToString() : null;
                                detail.GGT_DUYET = workSheet.Cells[startRow, 5] != null ? workSheet.Cells[startRow, 5].Value?.ToString() : null;
                                detail.GGT_TINHLAI = workSheet.Cells[startRow, 6] != null ? workSheet.Cells[startRow, 6].Value?.ToString() : null;
                                detail.GIATRI_HOPDONG = workSheet.Cells[startRow, 7] != null ? workSheet.Cells[startRow, 7].Value?.ToString() : null;
                                detail.HINHTHUC_HOPDONG = workSheet.Cells[startRow, 8] != null ? workSheet.Cells[startRow, 8].Value?.ToString() : null;
                                detail.GIATRI_HOPDONG_VUOTGIA = workSheet.Cells[startRow, 9] != null ? workSheet.Cells[startRow, 9].Value?.ToString() : null;
                                detail.GIATRI_KHOILUONG = workSheet.Cells[startRow, 10] != null ? workSheet.Cells[startRow, 10].Value?.ToString() : null;
                                detail.GIATRI_GIAINGAN = workSheet.Cells[startRow, 11] != null ? workSheet.Cells[startRow, 11].Value?.ToString() : null;
                                detail.GHICHU = workSheet.Cells[startRow, 12] != null ? workSheet.Cells[startRow, 12].Value?.ToString() : null;
