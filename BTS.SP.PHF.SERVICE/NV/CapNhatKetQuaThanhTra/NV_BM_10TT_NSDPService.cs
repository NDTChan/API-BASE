...
{
    public interface INV_BM_10TT_NSDPService : IBaseService<PHF_BM_10TT_NSDP>
    {
        string UploadFileReport(HttpRequest request, string currentUser, string unitCode, string report, string period);
    }
    public class NV_BM_10TT_NSDPService : BaseService<PHF_BM_10TT_NSDP>, INV_BM_10TT_NSDPService
    {
        private readonly IRepositoryAsync<PHF_BM_10TT_NSDP> _repository;
        public NV_BM_10TT_NSDPService(IRepositoryAsync<PHF_BM_10TT_NSDP> repository) : base(repository)
        {
        ...
        public string UploadFileReport(HttpRequest request, string currentUser, string unitCode, string report, string period)
        {
            try
            {
                List<PHF_BM_10TT_NSDP> listInsert = new List<PHF_BM_10TT_NSDP>();
                ...
                using (var excelPackage = new ExcelPackage(HttpContext.Current.Request.Files[0].InputStream))
                {
                    ...
                    if (workSheet != null)
                    {
                        ...
                        if (workSheet.Cells[rowHeader, 9] != null)
                        {
                            ...
                            {
                                bmfile_ncdp.TEN_BIEUMAU = "Biểu số 10 /TTTC-NSĐP";
                            }
                        }
                        int rowTitle = 3;
                        if (workSheet.Cells[rowTitle, 2] != null)
                        {
                            ...
                            {
                                bmfile_ncdp.TIEUDE_BIEUMAU = "BẢNG TỔNG HỢP SỐ LIỆU THỰC HIỆN KẾ HOẠCH VỐN ĐẦU TƯ XÂY DỰNG CƠ BẢN";
                            }
                        }
                        int startRow = 8;
                        int stt = 1;
                        ...
                        while (workSheet.Cells[startRow, 1].Value != null && !string.IsNullOrEmpty(workSheet.Cells[startRow, 1].Value.ToString()))
                        {
                            ...
                            {
                                PHF_BM_10TT_NSDP detail = new PHF_BM_10TT_NSDP()
                                {
                                    ObjectState = ObjectState.Added,
                                ...
                                detail.TEN_NGUONVON = workSheet.Cells[startRow, 2] != null ? workSheet.Cells[startRow, 2].Value?.ToString() : null;
                                ...
                                detail.DUTOAN = workSheet.Cells[startRow, 3] != null ? workSheet.Cells[startRow, 3].Value?.ToString() : null;
                                detail.SO_PHANBO = workSheet.Cells[startRow, 4] != null ? workSheet.Cells[startRow, 4].Value?.ToString() : null;
                                detail.TONGSO_GIAINGAN = workSheet.Cells[startRow, 5] != null ? workSheet.Cells[startRow, 5].Value?.ToString() : null;
                                detail.TONGSO_THANHTOAN = workSheet.Cells[startRow, 6] != null ? workSheet.Cells[startRow, 6].Value?.ToString() : null;
                                detail.TONGSO_TAMUNG = workSheet.Cells[startRow, 7] != null ? workSheet.Cells[startRow, 7].Value?.ToString() : null;
                                detail.TYLE_DUTOAN = workSheet.Cells[startRow, 8] != null ? workSheet.Cells[startRow, 8].Value?.ToString() : null;
                                detail.TYLE_PHANBO = workSheet.Cells[startRow, 9] != null ? workSheet.Cells[startRow, 9].Value?.ToString() : null;
