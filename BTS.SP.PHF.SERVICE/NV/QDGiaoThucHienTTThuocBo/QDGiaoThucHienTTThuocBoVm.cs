...
{
    public class QDGiaoThucHienTTThuocBoVm
    {
        ...
        public class Search : IDataSearch
        {
            ...
            public string DefaultOrder
            {
                ...
                get
                {
                    return ClassHelper.GetPropertyName(() => new PHF_QD_GIAOTHUCHIEN_TT_THUOCBO().SO_QUYETDINH);
            ...
            public List<IQueryFilter> GetFilters()
            {
                ...
                var refObj = new PHF_QD_GIAOTHUCHIEN_TT_THUOCBO();
