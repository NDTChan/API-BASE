...
define([
    ...
    'ngNotify',
    'telerikReportViewer'
], function (jquery, jqueryui, angular, state_auth, state_hethong, state_dm, state_nv, state_report) {
    'use strict';
    var app = angular.module('myApp', ['oc.lazyLoad', 'ui.router', 'InterceptorModule', 'LocalStorageModule', 'ui.bootstrap', 'configModule', 'tempDataModule',
        ...
        'ngFileUpload', 'ngSanitize', 'dynamicNumber', 'cp.ngConfirm', 'ckeditor', 'kendo.directives', 'ngNotify']);
    ...
    app.config(['$stateProvider', '$urlRouterProvider', '$ocLazyLoadProvider', 'localStorageServiceProvider', 'cfpLoadingBarProvider', '$httpProvider', 
        function ($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, localStorageServiceProvider, cfpLoadingBarProvider, $httpProvider) {
            ...
            localStorageServiceProvider.setStorageType('cookie').setPrefix('PHF');
            ...
            var lststate = [];
            lststate = lststate.concat(state_auth).concat(state_hethong).concat(state_dm).concat(state_nv).concat(state_report);
