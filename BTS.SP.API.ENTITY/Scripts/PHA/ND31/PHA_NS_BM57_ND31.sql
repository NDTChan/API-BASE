create or replace PROCEDURE "PHA_NS_BM57_ND31" (P_MA_DBHC IN NVARCHAR2,P_CONGTHUC VARCHAR2, TUNGAY_KS IN DATE, DENNGAY_KS IN DATE, TUNGAY_HL IN DATE, DENNGAY_HL IN DATE, P_CAP VARCHAR2, DONVI_TIEN number, cur OUT SYS_REFCURSOR) as
   P_INSERT_DT clob;
   P_INSERT_CHI clob;
...
--        END IF;
    ...
    P_INSERT_DT:='INSERT INTO PHA_THDT_HCSN_DT (MA_DIABAN,MA_TKTN,MA_CAP,MA_DVQHNS,TEN_DVQHNS,MA_CHUONG,TEN_CHUONG,MA_NGANHKT,MA_LOAI,MA_CTMTQG,MA_KBNN,MA_NGUON_NSNN,NGAY_KET_SO,NGAY_HIEU_LUC,ENTERED_DR,ENTERED_CR,ACCOUNTED_DR,ACCOUNTED_CR,ATTRIBUTE8,GIA_TRI_HACH_TOAN,MA_NVC)
    SELECT A.MA_DIABAN,A.MA_TKTN,A.MA_CAP,A.MA_DVQHNS,A.TEN_DVQHNS,A.MA_CHUONG,A.TEN_CHUONG,A.MA_NGANHKT,A.MA_LOAI,A.MA_CTMTQG,A.MA_KBNN,A.MA_NGUON_NSNN,A.NGAY_KET_SO,A.NGAY_HIEU_LUC,A.ENTERED_DR,A.ENTERED_CR,A.ACCOUNTED_DR,A.ACCOUNTED_CR,A.ATTRIBUTE8,A.GIA_TRI_HACH_TOAN,A.MA_NVC from PHA_DUTOAN A
    ...
    QUERY_STR:='SELECT HT.MA_CHUONG, HT.TEN_CHUONG, HT.MA_DVQHNS, NS.TEN_DVQHNS                      
                ...
                ,NVL(SUM (CASE WHEN ( MA_TKTN like ''81%'' OR MA_TKTN like ''82%'' OR (MA_TKTN BETWEEN ''1500'' AND ''1530'') OR (MA_TKTN BETWEEN ''1710'' AND ''1720'') OR MA_TKTN like ''1753'' OR MA_TKTN like ''1756'' OR MA_TKTN like ''1757'' OR (MA_TKTN BETWEEN ''8953'' AND ''8959'')) THEN A.GIA_TRI_HACH_TOAN/NVL('|| DONVI_TIEN ||',1) ELSE 0 END),0) AS KPTH                
                 ,0 AS CDT_QP
                ,0 AS CDT_AN
                            ,0 AS CDT_KH
                            ,0 AS CDT_HDKT
