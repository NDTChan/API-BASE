create or replace PROCEDURE PHA_BCCT_NEW (P_CAP IN NVARCHAR2,P_USER_NAME IN NVARCHAR2,P_MA_DBHC IN NVARCHAR2,P_LOAI_BAOCAO IN VARCHAR2, P_LOAI_DL IN VARCHAR2,MABAOCAO IN VARCHAR2,TABLENAME_TH IN VARCHAR2,P_TABLENAME IN VARCHAR2, TUNGAY_KS IN DATE, DENNGAY_KS IN DATE, TUNGAY_HL IN DATE, DENNGAY_HL IN DATE,P_CONGTHUC IN NVARCHAR2, DONVI_TIEN NUMBER, cur OUT SYS_REFCURSOR) IS
     ...
     BEGIN
      ...
      END IF;
       ...
       END IF;
        ...
        END IF;
        DBMS_OUTPUT.put_line('item_C '||P_CT);
      -- TAO TABLE 2
        ...
        BEGIN
                ...
                FOR item_C IN (SELECT MA_COT,CONGTHUC_WHERE,TRANG_THAI FROM DM_CHITIEU_BAOCAO_COL WHERE MA_BAOCAO=MABAOCAO ORDER BY STT ASC)
                    LOOP
                         ...
                         SELECT SUM(NVL(GIA_TRI,0)) INTO GIA_TRI_CLO  FROM V_COT_SO_LIEU  WHERE 
