...
{
    [Table("PHB_B02CTHP1_DETAIL")]
    public class PHB_B02CTHP1_DETAIL : DataInfoEntity
    {
        [Column("PHB_B02CTHP1_REFID")]
        [Required]
        [Description("Guid ID trong  PHB_B02CTHP1")]
        [StringLength(50)]
        public string PHB_B02CTHP1_REFID { get; set; }
