...
{
    [Table("DM_CHITIEU_DUTOAN")]
    public class DM_CHITIEU_DUTOAN : DataInfoEntity
    {
        [Column("REFID")]
        [StringLength(50)]
        [Description("GUID")]
        ...
        [Column("NAM_DUTOAN")]
        [StringLength(4)]
        [Description("Năm dự toán")]
        public string NAM_DUTOAN { get; set; }

        [Column("LOAI_DUTOAN")]
        [StringLength(10)]
        [Description("Loại dự toán; DAUNAM & DIEUCHINH")]
